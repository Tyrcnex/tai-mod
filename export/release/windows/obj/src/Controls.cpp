...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_572_removeKeyboard,"Controls","removeKeyboard",0xd2dac3e3,"Controls.removeKeyboard","Controls.hx",572,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_585_addGamepad,"Controls","addGamepad",0xa2c68b58,"Controls.addGamepad","Controls.hx",585,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_598_addGamepadLiteral,"Controls","addGamepadLiteral",0x50b4e0f7,"Controls.addGamepadLiteral","Controls.hx",598,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_611_removeGamepad,"Controls","removeGamepad",0xfdf294e5,"Controls.removeGamepad","Controls.hx",611,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_629_addDefaultGamepad,"Controls","addDefaultGamepad",0xaa5e6409,"Controls.addDefaultGamepad","Controls.hx",629,0x0ab041e8)
...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_663_bindButtons,"Controls","bindButtons",0x94dee42c,"Controls.bindButtons","Controls.hx",663,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_676_unbindButtons,"Controls","unbindButtons",0x83d33473,"Controls.unbindButtons","Controls.hx",676,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_700_getInputsFor,"Controls","getInputsFor",0xa3571ac2,"Controls.getInputsFor","Controls.hx",700,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_724_removeDevice,"Controls","removeDevice",0x4c1b5cd2,"Controls.removeDevice","Controls.hx",724,0x0ab041e8)
...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_684_addButtons,"Controls","addButtons",0xe3b5fcf8,"Controls.addButtons","Controls.hx",684,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_689_removeButtons,"Controls","removeButtons",0x3ee20685,"Controls.removeButtons","Controls.hx",689,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_735_isDevice,"Controls","isDevice",0xe09e10f8,"Controls.isDevice","Controls.hx",735,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_744_isGamepad,"Controls","isGamepad",0x5bcd81ff,"Controls.isGamepad","Controls.hx",744,0x0ab041e8)
...
HXLINE( 510)				{
HXLINE( 510)					::Array< int > keys4 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_447,3);
HXDLIN( 510)					switch((int)(::Control_obj::ACCEPT_dyn()->_hx_getIndex())){
            						case (int)0: {
HXLINE( 510)							{
HXLINE( 510)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 510)								int state = 1;
HXDLIN( 510)								int _g = 0;
HXDLIN( 510)								while((_g < keys4->length)){
HXLINE( 510)									int key = keys4->__get(_g);
HXDLIN( 510)									_g = (_g + 1);
...
HXDLIN( 510)								while((_g1 < keys4->length)){
HXLINE( 510)									int key = keys4->__get(_g1);
...
HXDLIN( 510)								while((_g2 < keys4->length)){
HXLINE( 510)									int key = keys4->__get(_g2);
...
HXLINE( 511)				{
HXLINE( 511)					::Array< int > keys5 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_448,2);
HXDLIN( 511)					switch((int)(::Control_obj::BACK_dyn()->_hx_getIndex())){
            						case (int)0: {
HXLINE( 511)							{
HXLINE( 511)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 511)								int state = 1;
HXDLIN( 511)								int _g = 0;
HXDLIN( 511)								while((_g < keys5->length)){
HXLINE( 511)									int key = keys5->__get(_g);
HXDLIN( 511)									_g = (_g + 1);
...
HXDLIN( 511)								while((_g1 < keys5->length)){
HXLINE( 511)									int key = keys5->__get(_g1);
...
HXDLIN( 511)								while((_g2 < keys5->length)){
HXLINE( 511)									int key = keys5->__get(_g2);
...
HXLINE( 512)				{
HXLINE( 512)					::Array< int > keys6 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_449,3);
HXDLIN( 512)					switch((int)(::Control_obj::PAUSE_dyn()->_hx_getIndex())){
            						case (int)0: {
HXLINE( 512)							{
HXLINE( 512)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 512)								int state = 1;
HXDLIN( 512)								int _g = 0;
HXDLIN( 512)								while((_g < keys6->length)){
HXLINE( 512)									int key = keys6->__get(_g);
HXDLIN( 512)									_g = (_g + 1);
...
HXDLIN( 512)								while((_g1 < keys6->length)){
HXLINE( 512)									int key = keys6->__get(_g1);
...
HXDLIN( 512)								while((_g2 < keys6->length)){
HXLINE( 512)									int key = keys6->__get(_g2);
...
HXLINE( 513)				{
HXLINE( 513)					::Array< int > keys7 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_450,1);
HXDLIN( 513)					switch((int)(::Control_obj::RESET_dyn()->_hx_getIndex())){
            						case (int)0: {
HXLINE( 513)							{
HXLINE( 513)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 513)								int state = 1;
HXDLIN( 513)								int _g = 0;
HXDLIN( 513)								while((_g < keys7->length)){
HXLINE( 513)									int key = keys7->__get(_g);
HXDLIN( 513)									_g = (_g + 1);
...
HXDLIN( 513)								while((_g1 < keys7->length)){
HXLINE( 513)									int key = keys7->__get(_g1);
...
HXDLIN( 513)								while((_g2 < keys7->length)){
HXLINE( 513)									int key = keys7->__get(_g2);
...
HXDLIN( 513)								action->addKey(key,state);
            			...
            			break;
            			case (int)1: {
HXLINE( 522)				if (scheme->_hx_getBool(0)) {
HXLINE( 515)					{
HXLINE( 515)						::Array< int > keys = ::Array_obj< int >::fromData( _hx_array_data_116e4296_451,2);
HXDLIN( 515)						switch((int)(::Control_obj::UP_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 515)								{
HXLINE( 515)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 515)									int state = 1;
HXDLIN( 515)									int _g = 0;
HXDLIN( 515)									while((_g < keys->length)){
HXLINE( 515)										int key = keys->__get(_g);
HXDLIN( 515)										_g = (_g + 1);
...
HXDLIN( 515)									while((_g1 < keys->length)){
HXLINE( 515)										int key = keys->__get(_g1);
...
HXDLIN( 515)									while((_g2 < keys->length)){
HXLINE( 515)										int key = keys->__get(_g2);
...
HXLINE( 516)					{
HXLINE( 516)						::Array< int > keys1 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_452,2);
HXDLIN( 516)						switch((int)(::Control_obj::DOWN_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 516)								{
...
HXLINE( 517)					{
HXLINE( 517)						::Array< int > keys2 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_453,2);
HXDLIN( 517)						switch((int)(::Control_obj::LEFT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 517)								{
HXLINE( 517)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 517)									int state = 1;
HXDLIN( 517)									int _g = 0;
HXDLIN( 517)									while((_g < keys2->length)){
HXLINE( 517)										int key = keys2->__get(_g);
HXDLIN( 517)										_g = (_g + 1);
...
HXDLIN( 517)									while((_g1 < keys2->length)){
HXLINE( 517)										int key = keys2->__get(_g1);
...
HXDLIN( 517)									while((_g2 < keys2->length)){
HXLINE( 517)										int key = keys2->__get(_g2);
...
HXLINE( 518)					{
HXLINE( 518)						::Array< int > keys3 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_454,2);
HXDLIN( 518)						switch((int)(::Control_obj::RIGHT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 518)								{
HXLINE( 518)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 518)									int state = 1;
HXDLIN( 518)									int _g = 0;
HXDLIN( 518)									while((_g < keys3->length)){
HXLINE( 518)										int key = keys3->__get(_g);
HXDLIN( 518)										_g = (_g + 1);
...
HXDLIN( 518)									while((_g1 < keys3->length)){
HXLINE( 518)										int key = keys3->__get(_g1);
...
HXDLIN( 518)									while((_g2 < keys3->length)){
HXLINE( 518)										int key = keys3->__get(_g2);
...
HXLINE( 519)					{
HXLINE( 519)						::Array< int > keys4 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_455,4);
HXDLIN( 519)						switch((int)(::Control_obj::ACCEPT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 519)								{
HXLINE( 519)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 519)									int state = 1;
HXDLIN( 519)									int _g = 0;
HXDLIN( 519)									while((_g < keys4->length)){
HXLINE( 519)										int key = keys4->__get(_g);
HXDLIN( 519)										_g = (_g + 1);
...
HXDLIN( 519)									while((_g1 < keys4->length)){
HXLINE( 519)										int key = keys4->__get(_g1);
...
HXDLIN( 519)									while((_g2 < keys4->length)){
HXLINE( 519)										int key = keys4->__get(_g2);
...
HXLINE( 520)					{
HXLINE( 520)						::Array< int > keys5 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_456,2);
HXDLIN( 520)						switch((int)(::Control_obj::BACK_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 520)								{
HXLINE( 520)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 520)									int state = 1;
HXDLIN( 520)									int _g = 0;
HXDLIN( 520)									while((_g < keys5->length)){
HXLINE( 520)										int key = keys5->__get(_g);
HXDLIN( 520)										_g = (_g + 1);
...
HXDLIN( 520)									while((_g1 < keys5->length)){
HXLINE( 520)										int key = keys5->__get(_g1);
...
HXDLIN( 520)									while((_g2 < keys5->length)){
HXLINE( 520)										int key = keys5->__get(_g2);
...
HXLINE( 521)					{
HXLINE( 521)						::Array< int > keys6 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_457,1);
HXDLIN( 521)						switch((int)(::Control_obj::RESET_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 521)								{
HXLINE( 521)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 521)									int state = 1;
HXDLIN( 521)									int _g = 0;
HXDLIN( 521)									while((_g < keys6->length)){
HXLINE( 521)										int key = keys6->__get(_g);
HXDLIN( 521)										_g = (_g + 1);
...
HXDLIN( 521)									while((_g1 < keys6->length)){
HXLINE( 521)										int key = keys6->__get(_g1);
...
HXDLIN( 521)									while((_g2 < keys6->length)){
HXLINE( 521)										int key = keys6->__get(_g2);
...
HXLINE( 523)					{
HXLINE( 523)						::Array< int > keys = ::Array_obj< int >::fromData( _hx_array_data_116e4296_458,1);
HXDLIN( 523)						switch((int)(::Control_obj::UP_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 523)								{
HXLINE( 523)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 523)									int state = 1;
HXDLIN( 523)									int _g = 0;
HXDLIN( 523)									while((_g < keys->length)){
HXLINE( 523)										int key = keys->__get(_g);
HXDLIN( 523)										_g = (_g + 1);
...
HXDLIN( 523)									while((_g1 < keys->length)){
HXLINE( 523)										int key = keys->__get(_g1);
...
HXDLIN( 523)									while((_g2 < keys->length)){
HXLINE( 523)										int key = keys->__get(_g2);
...
HXLINE( 524)					{
HXLINE( 524)						::Array< int > keys1 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_459,1);
HXDLIN( 524)						switch((int)(::Control_obj::DOWN_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 524)								{
HXLINE( 524)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 524)									int state = 1;
HXDLIN( 524)									int _g = 0;
HXDLIN( 524)									while((_g < keys1->length)){
HXLINE( 524)										int key = keys1->__get(_g);
HXDLIN( 524)										_g = (_g + 1);
...
HXDLIN( 524)									while((_g1 < keys1->length)){
HXLINE( 524)										int key = keys1->__get(_g1);
...
HXDLIN( 524)									while((_g2 < keys1->length)){
HXLINE( 524)										int key = keys1->__get(_g2);
...
HXLINE( 525)					{
HXLINE( 525)						::Array< int > keys2 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_460,1);
HXDLIN( 525)						switch((int)(::Control_obj::LEFT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 525)								{
HXLINE( 525)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 525)									int state = 1;
HXDLIN( 525)									int _g = 0;
HXDLIN( 525)									while((_g < keys2->length)){
HXLINE( 525)										int key = keys2->__get(_g);
HXDLIN( 525)										_g = (_g + 1);
...
HXDLIN( 525)									while((_g1 < keys2->length)){
HXLINE( 525)										int key = keys2->__get(_g1);
...
HXDLIN( 525)									while((_g2 < keys2->length)){
HXLINE( 525)										int key = keys2->__get(_g2);
...
HXLINE( 526)					{
HXLINE( 526)						::Array< int > keys3 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_461,1);
HXDLIN( 526)						switch((int)(::Control_obj::RIGHT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 526)								{
HXLINE( 526)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 526)									int state = 1;
HXDLIN( 526)									int _g = 0;
HXDLIN( 526)									while((_g < keys3->length)){
HXLINE( 526)										int key = keys3->__get(_g);
HXDLIN( 526)										_g = (_g + 1);
...
HXDLIN( 526)									while((_g1 < keys3->length)){
HXLINE( 526)										int key = keys3->__get(_g1);
...
HXDLIN( 526)									while((_g2 < keys3->length)){
HXLINE( 526)										int key = keys3->__get(_g2);
...
HXLINE( 527)					{
HXLINE( 527)						::Array< int > keys4 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_462,1);
HXDLIN( 527)						switch((int)(::Control_obj::ACCEPT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 527)								{
HXLINE( 527)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 527)									int state = 1;
HXDLIN( 527)									int _g = 0;
HXDLIN( 527)									while((_g < keys4->length)){
HXLINE( 527)										int key = keys4->__get(_g);
HXDLIN( 527)										_g = (_g + 1);
...
HXDLIN( 527)									while((_g1 < keys4->length)){
HXLINE( 527)										int key = keys4->__get(_g1);
...
HXDLIN( 527)									while((_g2 < keys4->length)){
HXLINE( 527)										int key = keys4->__get(_g2);
...
HXLINE( 528)					{
HXLINE( 528)						::Array< int > keys5 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_463,1);
HXDLIN( 528)						switch((int)(::Control_obj::BACK_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 528)								{
HXLINE( 528)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 528)									int state = 1;
HXDLIN( 528)									int _g = 0;
HXDLIN( 528)									while((_g < keys5->length)){
HXLINE( 528)										int key = keys5->__get(_g);
HXDLIN( 528)										_g = (_g + 1);
...
HXDLIN( 528)									while((_g1 < keys5->length)){
HXLINE( 528)										int key = keys5->__get(_g1);
...
HXDLIN( 528)									while((_g2 < keys5->length)){
HXLINE( 528)										int key = keys5->__get(_g2);
...
HXLINE( 529)					{
HXLINE( 529)						::Array< int > keys6 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_464,1);
HXDLIN( 529)						switch((int)(::Control_obj::PAUSE_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 529)									int state = 1;
HXDLIN( 529)									int _g = 0;
HXDLIN( 529)									while((_g < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g);
HXDLIN( 529)										_g = (_g + 1);
HXDLIN( 529)										action->addKey(key,state);
            									}
            								}
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 529)									int state1 = 2;
HXDLIN( 529)									int _g1 = 0;
HXDLIN( 529)									while((_g1 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g1);
HXDLIN( 529)										_g1 = (_g1 + 1);
HXDLIN( 529)										action1->addKey(key,state1);
            									}
            								}
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 529)									int state2 = -1;
HXDLIN( 529)									int _g2 = 0;
HXDLIN( 529)									while((_g2 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g2);
HXDLIN( 529)										_g2 = (_g2 + 1);
HXDLIN( 529)										action2->addKey(key,state2);
            									}
            								}
            							}
            							break;
            							case (int)1: {
HXLINE( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 529)									int state = 1;
HXDLIN( 529)									int _g = 0;
HXDLIN( 529)									while((_g < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g);
...
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 529)									int state1 = 2;
HXDLIN( 529)									int _g1 = 0;
HXDLIN( 529)									while((_g1 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g1);
...
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 529)									int state2 = -1;
HXDLIN( 529)									int _g2 = 0;
HXDLIN( 529)									while((_g2 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g2);
...
HXDLIN( 529)										action2->addKey(key,state2);
            							...
            							case (int)2: {
HXLINE( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 529)									int state = 1;
HXDLIN( 529)									int _g = 0;
HXDLIN( 529)									while((_g < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g);
...
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 529)									int state1 = 2;
HXDLIN( 529)									int _g1 = 0;
HXDLIN( 529)									while((_g1 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g1);
...
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 529)									int state2 = -1;
HXDLIN( 529)									int _g2 = 0;
HXDLIN( 529)									while((_g2 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g2);
...
HXDLIN( 529)										action2->addKey(key,state2);
            							...
            							case (int)3: {
HXLINE( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 529)									int state = 1;
HXDLIN( 529)									int _g = 0;
HXDLIN( 529)									while((_g < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g);
...
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 529)									int state1 = 2;
HXDLIN( 529)									int _g1 = 0;
HXDLIN( 529)									while((_g1 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g1);
...
HXDLIN( 529)								{
HXLINE( 529)									 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 529)									int state2 = -1;
HXDLIN( 529)									int _g2 = 0;
HXDLIN( 529)									while((_g2 < keys6->length)){
HXLINE( 529)										int key = keys6->__get(_g2);
...
HXDLIN( 529)										action2->addKey(key,state2);
            							...
            							break;
            							case (int)4: {
HXLINE( 529)								 ::flixel::input::actions::FlxActionDigital action = this->_reset;
HXDLIN( 529)								int state = 2;
HXDLIN( 529)								int _g = 0;
HXDLIN( 529)								while((_g < keys6->length)){
HXLINE( 529)									int key = keys6->__get(_g);
HXDLIN( 529)									_g = (_g + 1);
HXDLIN( 529)									action->addKey(key,state);
            							...
            							break;
            							case (int)5: {
HXLINE( 529)								 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 529)								int state = 2;
HXDLIN( 529)								int _g = 0;
HXDLIN( 529)								while((_g < keys6->length)){
HXLINE( 529)									int key = keys6->__get(_g);
...
HXDLIN( 529)									action->addKey(key,state);
            							...
            							break;
            							case (int)6: {
HXLINE( 529)								 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 529)								int state = 2;
HXDLIN( 529)								int _g = 0;
HXDLIN( 529)								while((_g < keys6->length)){
HXLINE( 529)									int key = keys6->__get(_g);
...
HXDLIN( 529)									action->addKey(key,state);
            							...
            							break;
            							case (int)7: {
HXLINE( 529)								 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 529)								int state = 2;
HXDLIN( 529)								int _g = 0;
HXDLIN( 529)								while((_g < keys6->length)){
HXLINE( 529)									int key = keys6->__get(_g);
...
HXDLIN( 529)									action->addKey(key,state);
            							...
            							break;
            							case (int)8: {
HXLINE( 529)								 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 529)								int state = 2;
HXDLIN( 529)								int _g = 0;
HXDLIN( 529)								while((_g < keys6->length)){
HXLINE( 529)									int key = keys6->__get(_g);
...
HXLINE( 530)					{
HXLINE( 530)						::Array< int > keys7 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_465,1);
HXDLIN( 530)						switch((int)(::Control_obj::RESET_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 530)								{
HXLINE( 530)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 530)									int state = 1;
HXDLIN( 530)									int _g = 0;
HXDLIN( 530)									while((_g < keys7->length)){
HXLINE( 530)										int key = keys7->__get(_g);
HXDLIN( 530)										_g = (_g + 1);
...
HXDLIN( 530)									while((_g1 < keys7->length)){
HXLINE( 530)										int key = keys7->__get(_g1);
...
HXDLIN( 530)									while((_g2 < keys7->length)){
HXLINE( 530)										int key = keys7->__get(_g2);
...
void Controls_obj::removeKeyboard(){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_572_removeKeyboard)
HXDLIN( 572)		int _g = 0;
HXDLIN( 572)		::Array< ::Dynamic> _g1 = this->digitalActions;
HXDLIN( 572)		while((_g < _g1->length)){
HXDLIN( 572)			 ::flixel::input::actions::FlxActionDigital action = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionDigital >();
HXDLIN( 572)			_g = (_g + 1);
HXLINE( 574)			int i = action->inputs->length;
HXLINE( 575)			while(true){
HXLINE( 575)				i = (i - 1);
HXDLIN( 575)				if (!(((i + 1) > 0))) {
HXLINE( 575)					goto _hx_goto_467;
            				}
HXLINE( 577)				 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 578)				if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
HXLINE( 579)					action->remove(input,null());
            				}
            			}
            			_hx_goto_467:;
            		}
...
void Controls_obj::addGamepad(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_585_addGamepad)
HXLINE( 586)		this->gamepadsAdded->push(id);
HXLINE( 589)		{
HXLINE( 589)			::Dynamic map = buttonMap;
HXDLIN( 589)			::Dynamic _g_map = map;
HXDLIN( 589)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 589)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 589)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 589)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 589)				 ::Control _g1_key = key;
HXDLIN( 589)				 ::Control control = _g1_key;
HXDLIN( 589)				::Array< int > buttons = _g1_value;
HXLINE( 590)				{
HXLINE( 590)					int id1 = id;
HXDLIN( 590)					::Array< int > buttons1 = buttons;
HXDLIN( 590)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXLINE( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 590)								int state = 1;
HXDLIN( 590)								int _g = 0;
HXDLIN( 590)								while((_g < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g);
HXDLIN( 590)									_g = (_g + 1);
HXDLIN( 590)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 590)								int state1 = 2;
HXDLIN( 590)								int _g1 = 0;
HXDLIN( 590)								while((_g1 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g1);
HXDLIN( 590)									_g1 = (_g1 + 1);
HXDLIN( 590)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 590)								int state2 = -1;
HXDLIN( 590)								int _g2 = 0;
HXDLIN( 590)								while((_g2 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g2);
HXDLIN( 590)									_g2 = (_g2 + 1);
HXDLIN( 590)									action2->addGamepad(button,state2,id1);
            								}
            							}
            						}
            						break;
            						case (int)1: {
HXLINE( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 590)								int state = 1;
HXDLIN( 590)								int _g = 0;
HXDLIN( 590)								while((_g < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g);
...
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 590)								int state1 = 2;
HXDLIN( 590)								int _g1 = 0;
HXDLIN( 590)								while((_g1 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g1);
...
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 590)								int state2 = -1;
HXDLIN( 590)								int _g2 = 0;
HXDLIN( 590)								while((_g2 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g2);
...
HXDLIN( 590)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXLINE( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 590)								int state = 1;
HXDLIN( 590)								int _g = 0;
HXDLIN( 590)								while((_g < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g);
...
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 590)								int state1 = 2;
HXDLIN( 590)								int _g1 = 0;
HXDLIN( 590)								while((_g1 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g1);
...
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 590)								int state2 = -1;
HXDLIN( 590)								int _g2 = 0;
HXDLIN( 590)								while((_g2 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g2);
...
HXDLIN( 590)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXLINE( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 590)								int state = 1;
HXDLIN( 590)								int _g = 0;
HXDLIN( 590)								while((_g < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g);
...
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 590)								int state1 = 2;
HXDLIN( 590)								int _g1 = 0;
HXDLIN( 590)								while((_g1 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g1);
...
HXDLIN( 590)							{
HXLINE( 590)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 590)								int state2 = -1;
HXDLIN( 590)								int _g2 = 0;
HXDLIN( 590)								while((_g2 < buttons1->length)){
HXLINE( 590)									int button = buttons1->__get(_g2);
...
HXDLIN( 590)									action2->addGamepad(button,state2,id1);
            						...
            						break;
            						case (int)4: {
HXLINE( 590)							 ::flixel::input::actions::FlxActionDigital action = this->_reset;
HXDLIN( 590)							int state = 2;
HXDLIN( 590)							int _g = 0;
HXDLIN( 590)							while((_g < buttons1->length)){
HXLINE( 590)								int button = buttons1->__get(_g);
HXDLIN( 590)								_g = (_g + 1);
HXDLIN( 590)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)5: {
HXLINE( 590)							 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 590)							int state = 2;
HXDLIN( 590)							int _g = 0;
HXDLIN( 590)							while((_g < buttons1->length)){
HXLINE( 590)								int button = buttons1->__get(_g);
...
HXDLIN( 590)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)6: {
HXLINE( 590)							 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 590)							int state = 2;
HXDLIN( 590)							int _g = 0;
HXDLIN( 590)							while((_g < buttons1->length)){
HXLINE( 590)								int button = buttons1->__get(_g);
...
HXDLIN( 590)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)7: {
HXLINE( 590)							 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 590)							int state = 2;
HXDLIN( 590)							int _g = 0;
HXDLIN( 590)							while((_g < buttons1->length)){
HXLINE( 590)								int button = buttons1->__get(_g);
...
HXDLIN( 590)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXLINE( 590)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 590)							int state = 2;
HXDLIN( 590)							int _g = 0;
HXDLIN( 590)							while((_g < buttons1->length)){
HXLINE( 590)								int button = buttons1->__get(_g);
...
void Controls_obj::addGamepadLiteral(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_598_addGamepadLiteral)
HXLINE( 599)		this->gamepadsAdded->push(id);
HXLINE( 602)		{
HXLINE( 602)			::Dynamic map = buttonMap;
HXDLIN( 602)			::Dynamic _g_map = map;
HXDLIN( 602)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 602)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 602)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 602)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 602)				 ::Control _g1_key = key;
HXDLIN( 602)				 ::Control control = _g1_key;
HXDLIN( 602)				::Array< int > buttons = _g1_value;
HXLINE( 603)				{
HXLINE( 603)					int id1 = id;
HXDLIN( 603)					::Array< int > buttons1 = buttons;
HXDLIN( 603)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXLINE( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 603)								int state = 1;
HXDLIN( 603)								int _g = 0;
HXDLIN( 603)								while((_g < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g);
HXDLIN( 603)									_g = (_g + 1);
HXDLIN( 603)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 603)								int state1 = 2;
HXDLIN( 603)								int _g1 = 0;
HXDLIN( 603)								while((_g1 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g1);
HXDLIN( 603)									_g1 = (_g1 + 1);
HXDLIN( 603)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 603)								int state2 = -1;
HXDLIN( 603)								int _g2 = 0;
HXDLIN( 603)								while((_g2 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g2);
HXDLIN( 603)									_g2 = (_g2 + 1);
HXDLIN( 603)									action2->addGamepad(button,state2,id1);
            								}
            							}
            						}
            						break;
            						case (int)1: {
HXLINE( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 603)								int state = 1;
HXDLIN( 603)								int _g = 0;
HXDLIN( 603)								while((_g < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g);
...
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 603)								int state1 = 2;
HXDLIN( 603)								int _g1 = 0;
HXDLIN( 603)								while((_g1 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g1);
...
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 603)								int state2 = -1;
HXDLIN( 603)								int _g2 = 0;
HXDLIN( 603)								while((_g2 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g2);
...
HXDLIN( 603)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXLINE( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 603)								int state = 1;
HXDLIN( 603)								int _g = 0;
HXDLIN( 603)								while((_g < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g);
...
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 603)								int state1 = 2;
HXDLIN( 603)								int _g1 = 0;
HXDLIN( 603)								while((_g1 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g1);
...
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 603)								int state2 = -1;
HXDLIN( 603)								int _g2 = 0;
HXDLIN( 603)								while((_g2 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g2);
...
HXDLIN( 603)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXLINE( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 603)								int state = 1;
HXDLIN( 603)								int _g = 0;
HXDLIN( 603)								while((_g < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g);
...
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 603)								int state1 = 2;
HXDLIN( 603)								int _g1 = 0;
HXDLIN( 603)								while((_g1 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g1);
...
HXDLIN( 603)							{
HXLINE( 603)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 603)								int state2 = -1;
HXDLIN( 603)								int _g2 = 0;
HXDLIN( 603)								while((_g2 < buttons1->length)){
HXLINE( 603)									int button = buttons1->__get(_g2);
...
HXDLIN( 603)									action2->addGamepad(button,state2,id1);
            						...
            						break;
            						case (int)4: {
HXLINE( 603)							 ::flixel::input::actions::FlxActionDigital action = this->_reset;
HXDLIN( 603)							int state = 2;
HXDLIN( 603)							int _g = 0;
HXDLIN( 603)							while((_g < buttons1->length)){
HXLINE( 603)								int button = buttons1->__get(_g);
HXDLIN( 603)								_g = (_g + 1);
HXDLIN( 603)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)5: {
HXLINE( 603)							 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 603)							int state = 2;
HXDLIN( 603)							int _g = 0;
HXDLIN( 603)							while((_g < buttons1->length)){
HXLINE( 603)								int button = buttons1->__get(_g);
...
HXDLIN( 603)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)6: {
HXLINE( 603)							 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 603)							int state = 2;
HXDLIN( 603)							int _g = 0;
HXDLIN( 603)							while((_g < buttons1->length)){
HXLINE( 603)								int button = buttons1->__get(_g);
...
HXDLIN( 603)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)7: {
HXLINE( 603)							 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 603)							int state = 2;
HXDLIN( 603)							int _g = 0;
HXDLIN( 603)							while((_g < buttons1->length)){
HXLINE( 603)								int button = buttons1->__get(_g);
...
HXDLIN( 603)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXLINE( 603)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 603)							int state = 2;
HXDLIN( 603)							int _g = 0;
HXDLIN( 603)							while((_g < buttons1->length)){
HXLINE( 603)								int button = buttons1->__get(_g);
...
void Controls_obj::removeGamepad(::hx::Null< int >  __o_deviceID){
            	...
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_611_removeGamepad)
HXLINE( 612)		{
HXLINE( 612)			int _g = 0;
HXDLIN( 612)			::Array< ::Dynamic> _g1 = this->digitalActions;
HXDLIN( 612)			while((_g < _g1->length)){
HXLINE( 612)				 ::flixel::input::actions::FlxActionDigital action = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionDigital >();
HXDLIN( 612)				_g = (_g + 1);
HXLINE( 614)				int i = action->inputs->length;
HXLINE( 615)				while(true){
HXLINE( 615)					i = (i - 1);
HXDLIN( 615)					if (!(((i + 1) > 0))) {
HXLINE( 615)						goto _hx_goto_508;
            					}
HXLINE( 617)					 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 618)					bool _hx_tmp;
HXDLIN( 618)					if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 618)						if ((deviceID != -1)) {
HXLINE( 618)							_hx_tmp = (input->deviceID == deviceID);
            						}
            						else {
...
HXLINE( 619)						action->remove(input,null());
            					}
            				}
            				_hx_goto_508:;
            			}
            		}
HXLINE( 623)		this->gamepadsAdded->remove(deviceID);
            	}
...
void Controls_obj::addDefaultGamepad(int id){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_629_addDefaultGamepad)
HXDLIN( 629)		 ::haxe::ds::EnumValueMap _g =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXDLIN( 629)		_g->set(::Control_obj::ACCEPT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_529,1));
HXDLIN( 629)		_g->set(::Control_obj::BACK_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_530,1));
HXDLIN( 629)		_g->set(::Control_obj::UP_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_531,2));
HXDLIN( 629)		_g->set(::Control_obj::DOWN_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_532,2));
HXDLIN( 629)		_g->set(::Control_obj::LEFT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_533,2));
HXDLIN( 629)		_g->set(::Control_obj::RIGHT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_534,2));
HXDLIN( 629)		_g->set(::Control_obj::PAUSE_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_535,1));
HXDLIN( 629)		_g->set(::Control_obj::RESET_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_536,1));
HXDLIN( 629)		this->gamepadsAdded->push(id);
HXDLIN( 629)		{
HXDLIN( 629)			::Dynamic map = _g;
HXDLIN( 629)			::Dynamic _g_map = map;
HXDLIN( 629)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 629)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 629)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 629)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 629)				 ::Control _g1_key = key;
HXDLIN( 629)				 ::Control control = _g1_key;
HXDLIN( 629)				::Array< int > buttons = _g1_value;
HXDLIN( 629)				{
HXDLIN( 629)					int id1 = id;
HXDLIN( 629)					::Array< int > buttons1 = buttons;
HXDLIN( 629)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g);
HXDLIN( 629)									_g = (_g + 1);
HXDLIN( 629)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g1);
HXDLIN( 629)									_g1 = (_g1 + 1);
HXDLIN( 629)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g2);
...
HXDLIN( 629)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)1: {
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g);
...
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g1);
...
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g2);
...
HXDLIN( 629)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g);
...
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g1);
...
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g2);
...
HXDLIN( 629)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g);
...
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g1);
...
HXDLIN( 629)							{
HXDLIN( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXDLIN( 629)									int button = buttons1->__get(_g2);
...
HXDLIN( 629)									action2->addGamepad(button,state2,id1);
            						...
            						break;
            						case (int)4: {
HXDLIN( 629)							 ::flixel::input::actions::FlxActionDigital action = this->_reset;
...
HXDLIN( 629)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)5: {
HXDLIN( 629)							 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 629)							int state = 2;
HXDLIN( 629)							int _g = 0;
HXDLIN( 629)							while((_g < buttons1->length)){
HXDLIN( 629)								int button = buttons1->__get(_g);
...
HXDLIN( 629)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)6: {
HXDLIN( 629)							 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 629)							int state = 2;
HXDLIN( 629)							int _g = 0;
HXDLIN( 629)							while((_g < buttons1->length)){
HXDLIN( 629)								int button = buttons1->__get(_g);
...
HXDLIN( 629)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)7: {
HXDLIN( 629)							 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 629)							int state = 2;
HXDLIN( 629)							int _g = 0;
HXDLIN( 629)							while((_g < buttons1->length)){
HXDLIN( 629)								int button = buttons1->__get(_g);
...
HXDLIN( 629)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXDLIN( 629)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 629)							int state = 2;
HXDLIN( 629)							int _g = 0;
HXDLIN( 629)							while((_g < buttons1->length)){
HXDLIN( 629)								int button = buttons1->__get(_g);
...
void Controls_obj::bindButtons( ::Control control,int id,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_663_bindButtons)
...
HXDLIN( 663)					int _g = 0;
HXDLIN( 663)					while((_g < buttons->length)){
HXDLIN( 663)						int button = buttons->__get(_g);
HXDLIN( 663)						_g = (_g + 1);
HXDLIN( 663)						action->addGamepad(button,state,id);
            					}
            				}
HXDLIN( 663)				{
...
HXDLIN( 663)					while((_g1 < buttons->length)){
HXDLIN( 663)						int button = buttons->__get(_g1);
HXDLIN( 663)						_g1 = (_g1 + 1);
HXDLIN( 663)						action1->addGamepad(button,state1,id);
            					}
            				}
HXDLIN( 663)				{
...
HXDLIN( 663)					while((_g2 < buttons->length)){
HXDLIN( 663)						int button = buttons->__get(_g2);
HXDLIN( 663)						_g2 = (_g2 + 1);
HXDLIN( 663)						action2->addGamepad(button,state2,id);
            					}
            				}
            			}
            			break;
...
void Controls_obj::unbindButtons( ::Control control,int gamepadID,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_676_unbindButtons)
HXDLIN( 676)		switch((int)(control->_hx_getIndex())){
            			case (int)0: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_up,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_upP,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_upR,gamepadID,buttons);
            			}
            			break;
            			case (int)1: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_left,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_leftP,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_leftR,gamepadID,buttons);
            			}
            			break;
            			case (int)2: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_right,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_rightP,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_rightR,gamepadID,buttons);
            			}
            			break;
            			case (int)3: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_down,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_downP,gamepadID,buttons);
HXDLIN( 676)				::Controls_obj::removeButtons(this->_downR,gamepadID,buttons);
            			}
            			break;
            			case (int)4: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_reset,gamepadID,buttons);
            			}
            			break;
            			case (int)5: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_accept,gamepadID,buttons);
            			}
            			break;
            			case (int)6: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_back,gamepadID,buttons);
            			}
            			break;
            			case (int)7: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_pause,gamepadID,buttons);
            			}
            			break;
            			case (int)8: {
HXDLIN( 676)				::Controls_obj::removeButtons(this->_cheat,gamepadID,buttons);
            			}
            			break;
            		}
            	}
...
::Array< int > Controls_obj::getInputsFor( ::Control control, ::Device device,::Array< int > list){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_700_getInputsFor)
HXLINE( 701)		if (::hx::IsNull( list )) {
HXLINE( 702)			list = ::Array_obj< int >::__new(0);
            		}
HXLINE( 704)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 707)				int _g = 0;
HXDLIN( 707)				::Array< ::Dynamic> _g1 = this->getActionFromControl(control)->inputs;
HXDLIN( 707)				while((_g < _g1->length)){
HXLINE( 707)					 ::flixel::input::actions::FlxActionInput input = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXDLIN( 707)					_g = (_g + 1);
HXLINE( 709)					if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
HXLINE( 710)						list->push(input->inputID);
            					}
            				}
            			}
            			break;
            			case (int)1: {
HXLINE( 712)				int id = device->_hx_getInt(0);
HXLINE( 713)				{
HXLINE( 713)					int _g = 0;
HXDLIN( 713)					::Array< ::Dynamic> _g1 = this->getActionFromControl(control)->inputs;
HXDLIN( 713)					while((_g < _g1->length)){
HXLINE( 713)						 ::flixel::input::actions::FlxActionInput input = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXDLIN( 713)						_g = (_g + 1);
HXLINE( 715)						if ((input->deviceID == id)) {
HXLINE( 716)							list->push(input->inputID);
            						}
            					}
            				}
            			}
...
void Controls_obj::removeDevice( ::Device device){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_724_removeDevice)
HXDLIN( 724)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 727)				this->setKeyboardScheme(::KeyboardScheme_obj::None_dyn(),null());
            			}
            			break;
            			case (int)1: {
HXLINE( 728)				int id = device->_hx_getInt(0);
HXLINE( 729)				this->removeGamepad(id);
            			}
            			break;
            		}
            	}
...
void Controls_obj::addButtons( ::flixel::input::actions::FlxActionDigital action,::Array< int > buttons,int state,int id){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_684_addButtons)
HXDLIN( 684)		int _g = 0;
HXDLIN( 684)		while((_g < buttons->length)){
HXDLIN( 684)			int button = buttons->__get(_g);
HXDLIN( 684)			_g = (_g + 1);
HXLINE( 685)			action->addGamepad(button,state,id);
            		}
            	}
...
void Controls_obj::removeButtons( ::flixel::input::actions::FlxActionDigital action,int gamepadID,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_689_removeButtons)
HXLINE( 690)		int i = action->inputs->length;
HXLINE( 691)		while(true){
HXLINE( 691)			i = (i - 1);
HXDLIN( 691)			if (!(((i + 1) > 0))) {
HXLINE( 691)				goto _hx_goto_567;
            			}
HXLINE( 693)			 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 694)			bool _hx_tmp;
HXDLIN( 694)			bool _hx_tmp1;
HXDLIN( 694)			if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 694)				if ((gamepadID != -1)) {
HXLINE( 694)					_hx_tmp1 = (input->deviceID == gamepadID);
            				}
            				else {
...
HXLINE( 694)				_hx_tmp = (buttons->indexOf(input->inputID,null()) != -1);
            			}
            			else {
HXLINE( 694)				_hx_tmp = false;
            			}
HXDLIN( 694)			if (_hx_tmp) {
HXLINE( 695)				action->remove(input,null());
            			}
            		}
            		_hx_goto_567:;
            	}
...
bool Controls_obj::isDevice( ::flixel::input::actions::FlxActionInput input, ::Device device){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_735_isDevice)
HXDLIN( 735)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 737)				return ::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() );
            			}
            			break;
            			case (int)1: {
HXLINE( 738)				int id = device->_hx_getInt(0);
HXDLIN( 738)				if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 738)					if ((id != -1)) {
HXLINE( 738)						return (input->deviceID == id);
            					}
            					else {
HXLINE( 738)						return true;
            					}
            				}
            				else {
...
bool Controls_obj::isGamepad( ::flixel::input::actions::FlxActionInput input,int deviceID){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_744_isGamepad)
HXDLIN( 744)		if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXDLIN( 744)			if ((deviceID != -1)) {
HXDLIN( 744)				return (input->deviceID == deviceID);
            			}
            			else {
HXDLIN( 744)				return true;
            			}
            		}
            		else {
HXDLIN( 744)			return false;
            		}
HXDLIN( 744)		return false;
            	}
