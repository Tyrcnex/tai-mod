...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FNF VSTai Mod",7f,d0,a7,c1),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("30",9d,2c,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("ninjamuffin99",f7,4c,e5,00));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("FNF VSTai Mod",7f,d0,a7,c1));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin' Mod - VSTai",3b,12,26,0e));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin' Mod - VSTai",3b,12,26,0e))
