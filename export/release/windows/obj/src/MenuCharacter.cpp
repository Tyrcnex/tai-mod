...
HXLINE(  56)		this->animation->addByPrefix(HX_("tai",5c,5a,58,00),HX_("TAI idle Black Lines",f6,cf,2b,db),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("tai",5c,5a,58,00), ::CharacterSetting_obj::__alloc( HX_CTX ,0,-20,((Float)1.0),null()));
HXDLIN(  24)			return _g;
            		}
