...
@:keep @:image("assets/shared/images/weeb/taiDemonPortrait.png") @:noCompletion #if display private #end class __ASSET__assets_shared_images_weeb_taidemonportrait_png extends lime.graphics.Image {}
@:keep @:file("assets/shared/images/weeb/taiDemonPortrait.xml") @:noCompletion #if display private #end class __ASSET__assets_shared_images_weeb_taidemonportrait_xml extends haxe.io.Bytes {}
