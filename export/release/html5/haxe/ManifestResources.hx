...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_hahabgmoment_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("assets/shared/images/hahabgmoment.png") @:noCompletion #if display private #end class __ASSET__assets_shared_images_hahabgmoment_png extends lime.graphics.Image {}
