...
HXLINE( 578)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
void Controls_obj::addGamepad(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_585_addGamepad)
HXLINE( 586)		this->gamepadsAdded->push(id);
HXLINE( 589)		{
HXLINE( 589)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,buttonMap);
HXDLIN( 589)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 589)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 589)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 589)				::Array< int > buttons = ( (::Array< int >)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 590)				{
...
void Controls_obj::addGamepadLiteral(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_598_addGamepadLiteral)
HXLINE( 599)		this->gamepadsAdded->push(id);
HXLINE( 602)		{
HXLINE( 602)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,buttonMap);
...
HXDLIN( 602)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 602)				::Array< int > buttons = ( (::Array< int >)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 603)				{
...
HXDLIN( 618)					if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
...
HXDLIN( 629)		{
HXDLIN( 629)			 ::Dynamic _g1 =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,_g);
HXDLIN( 629)			while(( (bool)(_g1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 629)				 ::Dynamic _g = _g1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 629)				 ::Control control = _g->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 629)				::Array< int > buttons = ( (::Array< int >)(_g->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXDLIN( 629)				{
...
HXDLIN( 707)					_g = (_g + 1);
HXLINE( 709)					if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
HXDLIN( 694)			if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
...
HXDLIN( 735)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 737)				return ::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() );
            			}
            			break;
            			case (int)1: {
HXLINE( 738)				int id = device->_hx_getInt(0);
HXDLIN( 738)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 738)					if ((id != -1)) {
...
HXDLIN( 744)		if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
