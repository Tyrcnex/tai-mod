...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FNF VSTai Mod", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FNF VSTai Mod", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FNF VSTai Mod";
		app.meta["name"] = "Friday Night Funkin' Mod - VSTai";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin' Mod - VSTai",
			width: 1280,
			x: null,
			y: null,
		};
